<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST")
    {
        ...
        $login  = authTrainee($_POST['email'], $_POST['password']);
        if ($login)
        {
            header('location: ./trainee/home.php'); // redirecting to home page
        ...
        <div class="row h-100 d-flex justify-content-center">
            <div class="col-md-6 d-flex justify-content-center align-items-center">
                <div class="contact-form px-3 py-5 bg-white rounded-3 shadow">
                    <h3 class="text-success fw-bold text-center mb-3">الدخول كمتدرب</h3>
